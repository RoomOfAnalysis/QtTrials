    ...
    : SARibbonMainWindow(par), mWidgetForCustomize(nullptr), mMenuApplicationBtn(nullptr)
{
    ...
    connect(ribbon, &SARibbonBar::currentRibbonTabChanged, this,
            [this](int v) { mTextedit->append(QString("SARibbonBar::currentRibbonTabChanged(%1)").arg(v)); });
...
{
    if (mContextCategory == nullptr) createContextCategory1();
    if (on)
...
void MainWindow::onActionCustomizeAndSaveTriggered()
{
    ...
    {
        auto res = QMessageBox::question(this, tr("question"),
...
void MainWindow::onActionCustomizeAndSaveWithApplyTriggered()
{
    ...
    {
        if (widgetForCustomize->isCached()) widgetForCustomize->applys();
...
void MainWindow::onActionVisibleAllTriggered(bool on)
{
    ...
    for (QAction* a : acts)
        if (a != mActionVisibleAll) a->setVisible(on);
    ribbonBar()->updateRibbonGeometry();
}
...
void MainWindow::onSpinBoxRibbonPannelSpacingChanged(int h)
{
...
void MainWindow::createCategoryMain(SARibbonCategory* page)
{
    ...
    connect(actShowHideButton, &QAction::triggered, this,
            [this](bool b) { this->ribbonBar()->showMinimumModeButton(b); });
    ...
    connect(mComboboxRibbonTheme, QOverload<int>::of(&SARibbonComboBox::currentIndexChanged), this,
...
void MainWindow::createCategoryOther(SARibbonCategory* page)
{
    ...
    auto lambdaCreateGalleryAction = [this](const QString& text, const QString& iconurl) -> QAction* {
        ...
        this->connect(act, &QAction::triggered, this, [this, text]() {
            if (this->mTextedit) this->mTextedit->append(QString("%1 triggered").arg(text));
        });
        return act;
    };
    ...
    galleryActions.append(
        lambdaCreateGalleryAction("Drive File Four Word", ":/gallery-icon/icon/gallery/Drive-File.svg"));
    ...
    QAction* actionLoadCustomizeXmlFile =
        createAction(tr("load customize from xml file"), ":/icon/icon/useCustomize.svg");
    ...
    QAction* actionWindowFlagNormalButton =
        createAction(tr("window normal button"), ":/icon/icon/windowsflag-normal.svg");
    ...
    connect(a1, &QAction::triggered, this,
            [this](bool c) { this->ribbonBar()->setContextCategoryVisible(mContextCategory, c); });

    QAction* a2 = createAction("Context Category 2", ":/icon/icon/ContextCategory.svg");
    a2->setCheckable(true);
    connect(a2, &QAction::triggered, this,
            [this](bool c) { this->ribbonBar()->setContextCategoryVisible(mContextCategory2, c); });
...
void MainWindow::createCategorySize(SARibbonCategory* page)
{
    ...
    SARibbonButtonGroupWidget* groupFontFamile = new SARibbonButtonGroupWidget(pannel);
    ...
    QAction* actWidgetFontFamile = pannel->addWidget(groupFontFamile, SARibbonPannelItem::Medium);

    actWidgetFontFamile->setObjectName(QStringLiteral("Size.Font.FontFamile"));

    SARibbonButtonGroupWidget* groupFontTools = new SARibbonButtonGroupWidget(pannel);
    ...
    QAction* actWidgetFontTools = pannel->addWidget(groupFontTools, SARibbonPannelItem::Medium);
    ...
    QLabel* lab4 = new QLabel("Ribbon Pannel Spacing:");
    ...
    connect(spinboxRibbonCategoryHeight, &QSpinBox::valueChanged, this,
            &MainWindow::onSpinBoxRibbonCategoryHeightChanged);
    connect(spinboxRibbonPannelTtitleHeight, &QSpinBox::valueChanged, this,
            &MainWindow::onSpinBoxRibbonPannelTtitleHeightChanged);
    connect(spinboxRibbonPannelSpacing, &QSpinBox::valueChanged, this,
            &MainWindow::onSpinBoxRibbonPannelSpacingChanged);
    connect(spinboxRibbonPannelToolBtnIconSize, &QSpinBox::valueChanged, this,
...
void MainWindow::createContextCategoryPage2(SARibbonCategory* page)
{
    ...
    pannelLayout->addAction(createAction("Large", ":/icon/icon/layout.svg", "@Large1"), QToolButton::InstantPopup,
                            SARibbonPannelItem::Large);
    pannelLayout->addAction(createAction("Small", ":/icon/icon/layout.svg", "@Small1"), QToolButton::InstantPopup,
                            SARibbonPannelItem::Small);
    pannelLayout->addAction(createAction("Small", ":/icon/icon/layout.svg", "@Small2"), QToolButton::InstantPopup,
                            SARibbonPannelItem::Small);
    pannelLayout->addSeparator();
    pannelLayout->addAction(createAction("Small", ":/icon/icon/layout.svg", "@Small3"), QToolButton::InstantPopup,
                            SARibbonPannelItem::Small);
    pannelLayout->addAction(createAction("Small", ":/icon/icon/layout.svg", "@Small4"), QToolButton::InstantPopup,
                            SARibbonPannelItem::Small);
    pannelLayout->addAction(createAction("Small", ":/icon/icon/layout.svg", "@Small5"), QToolButton::InstantPopup,
                            SARibbonPannelItem::Small);
    pannelLayout->addAction(createAction("Small", ":/icon/icon/layout.svg", "@Small6"), QToolButton::InstantPopup,
                            SARibbonPannelItem::Small);
    pannelLayout->addSeparator();
    pannelLayout->addAction(createAction("Large", ":/icon/icon/layout.svg", "@Large2"), QToolButton::InstantPopup,
                            SARibbonPannelItem::Large);
    pannelLayout->addAction(createAction("Medium", ":/icon/icon/layout.svg", "@Medium1"), QToolButton::InstantPopup,
                            SARibbonPannelItem::Medium);
    pannelLayout->addAction(createAction("Medium", ":/icon/icon/layout.svg", "@Medium2"), QToolButton::InstantPopup,
                            SARibbonPannelItem::Medium);
    pannelLayout->addAction(createAction("Small", ":/icon/icon/layout.svg", "@Small7"), QToolButton::InstantPopup,
                            SARibbonPannelItem::Small);
    pannelLayout->addAction(createAction("Medium", ":/icon/icon/layout.svg", "@Medium3"), QToolButton::InstantPopup,
                            SARibbonPannelItem::Medium);
    pannelLayout->addAction(createAction("Large", ":/icon/icon/layout.svg", "@Large3"), QToolButton::InstantPopup,
                            SARibbonPannelItem::Large);
    pannelLayout->addAction(createAction("Medium", ":/icon/icon/layout.svg", "@Medium4"), QToolButton::InstantPopup,
                            SARibbonPannelItem::Medium);
    pannelLayout->addAction(createAction("Medium", ":/icon/icon/layout.svg", "@Medium5"), QToolButton::InstantPopup,
                            SARibbonPannelItem::Medium);
    pannelLayout->addAction(createAction("Large", ":/icon/icon/layout.svg", "@Large4"), QToolButton::InstantPopup,
                            SARibbonPannelItem::Large);
    pannelLayout->addSeparator();
    pannelLayout->addAction(createAction("Medium", ":/icon/icon/layout.svg", "@Medium6"), QToolButton::InstantPopup,
                            SARibbonPannelItem::Medium);
    pannelLayout->addAction(createAction("Large", ":/icon/icon/layout.svg", "@Large5"), QToolButton::InstantPopup,
                            SARibbonPannelItem::Large);
    pannelLayout->addAction(createAction("Medium", ":/icon/icon/layout.svg", "@Medium7"), QToolButton::InstantPopup,
                            SARibbonPannelItem::Medium);
    pannelLayout->addAction(createAction("Small", ":/icon/icon/layout.svg", "@Small8"), QToolButton::InstantPopup,
                            SARibbonPannelItem::Small);
}
...
void MainWindow::createQuickAccessBar()
{
    ...
    QAction* actionCustomizeAndSaveWithApply =
        createAction("customize and save with apply", ":/icon/icon/customize.svg");
    quickAccessBar->addAction(actionCustomizeAndSaveWithApply);
    connect(actionCustomizeAndSaveWithApply, &QAction::triggered, this,
            &MainWindow::onActionCustomizeAndSaveWithApplyTriggered);
    ...
    connect(mSearchEditor, &QLineEdit::editingFinished, this,
            [this]() { this->mTextedit->append(this->mSearchEditor->text()); });
}
