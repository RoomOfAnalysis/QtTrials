...
public:
    //保留接口
    SARibbonCustomizeWidget(SARibbonMainWindow* ribbonWindow, QWidget* parent = nullptr,
    ...
    enum ItemRole
    {
        ...
        CustomizeRole =
            Qt::UserRole +
            4, ///< 代表这个是自定义的item,bool,主要用于那些自己添加的标签和pannel，有此角色必有CanCustomizeRole
 ...
 * @endcode
 */
bool SA_RIBBON_EXPORT sa_apply_customize_from_xml_file(const QString& filePath, SARibbonBar* bar,
                                                       SARibbonActionsManager* mgr);
