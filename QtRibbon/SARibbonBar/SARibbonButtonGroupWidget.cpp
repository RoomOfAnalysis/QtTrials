...
void SARibbonButtonGroupWidget::PrivateData::removeAction(QAction* a)
{
    ...
    for (int i = 0; i < c; ++i)
    {
        ...
        if (a == btn->defaultAction()) willRemoveItems.push_back(item);
    }
    // 从尾部删除
 ...
 * @return
 */
QAction* SARibbonButtonGroupWidget::addAction(const QString& text, const QIcon& icon, Qt::ToolButtonStyle buttonStyle,
                                              QToolButton::ToolButtonPopupMode popMode)
{
...
QAction* SARibbonButtonGroupWidget::addMenu(QMenu* menu, Qt::ToolButtonStyle buttonStyle,
                                            QToolButton::ToolButtonPopupMode popMode)
{
