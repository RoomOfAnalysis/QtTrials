...
CropRubberBand::~CropRubberBand() = default;

void CropRubberBand::show()
{
    setFocus();
...
void CropRubberBand::mouseReleaseEvent(QMouseEvent* event)
{
...
void CropRubberBand::resizeEvent(QResizeEvent*)
{
    ...
    emit selectionChanged(m_rubberband->geometry());
}